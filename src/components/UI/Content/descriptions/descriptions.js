                ...
                props.req ?
                    <div className="requirementItem">
                        ...
                        <div className="requirementDesc">
                            <p>Студентам необходимо поступить на одну из программ магистратуры факультета науки.
                                После <span>заполнения заявки</span>, Вы увидите сообщение, в котором будет сказано, что
                                заявка успешно подана. Вам необходимо сделать скриншот данного сообщения. Потом
                                необходимо подать заявку на стипендию и загрузить скриншот сообщения.</p>
                            <p>На получение стипендии будут рассмотрены только те кандидаты, которые были зачислены на
                                обучение и зарегистрировались на сайте стипендии до 15 февраля.</p>
                    ...
                    <div className="requirementList">
                        ...
                        <ul>
                            {props.services.map((req, i) => (<li key={i}>{req}</li>))}
                        </ul>
                    </div>
            }
            {
                props.contacts ?
                    <div className='contactDesc'>
                        <h1>Контакты:</h1>
                        {props.contacts.map((req, i) => (<p key={i}>{req}</p>))}
                    </div>
                    :
                    null
            }
